...
def test_1tcheck_1vs_down_01():
    ...
    tcheck.stop_vs(['vs1'])
    tcheck.check_db([('vs1', 0)], 90)

    tcheck.start_vs(['vs1'])
    tcheck.check_db([('vs1', 1)], 90)
...
def test_1tcheck_3vs_1down_02():
    ...
    tcheck.start_vs(['vs1'])
    tcheck.check_db([('vs1', 1), ('vs2', 1), ('vs3', 1)], 80)
    logger.debug("# Test # test stopped and success!!!")
...
# 3 tcheck, itvl=60, timeout=10, retries=2, 3 sec start
def test_3tcheck_60itvl_3start_11():
    conf['vs'] = {'vs1': {'vs_ip': '10.235.160.66', 'host_name':'vkvm160066.sqa.cm6', \
