...
def test_1tcheck_1vs_1uri_2down_10():
    conf['tcheck'] = {'master': 'master','slave':['slave1']}
    conf['vs'] = {'vs1': {'vs_ip': '10.235.160.66', 'host_name':'vkvm160066.sqa.cm6', 'HC_type':1, 'url': '/11; /12; /1;'}}
    tcheck.deploy(conf)
...
def test_1tcheck_1vs_3uri_0down_11():
    conf['tcheck'] = {'master': 'master','slave':['slave1']}
    conf['vs'] = {'vs1': {'vs_ip': '10.235.160.66', 'host_name':'vkvm160066.sqa.cm6', 'HC_type':1, 'url': '/1; /2; /3;'}}
    tcheck.deploy(conf)
...
def test_1tcheck_3vs_3uri_partdown_14():
    conf['tcheck'] = {'master': 'master','slave':['slave1']}
    conf['vs']={'vs1': {'vs_ip': '10.235.160.66', 'host_name':'vkvm160066.sqa.cm6', 'HC_type':1, 'url': '/11; /1; /2;'},
                'vs2': {'vs_ip': '10.235.160.76', 'host_name':'vkvm160076.sqa.cm6', 'HC_type':1, 'url': '/11; /12; /1;'},
                'vs3': {'vs_ip': '10.235.160.86', 'host_name':'vkvm160086.sqa.cm6', 'HC_type':1, 'url': '/1; /12; /2;'}},
    tcheck.deploy(conf)
...
def test_1tcheck_3vs_3uri_RSdown_15():
    conf['tcheck'] = {'master': 'master','slave':['slave1']}
    conf['vs']={'vs1': {'vs_ip': '10.235.160.66', 'host_name':'vkvm160066.sqa.cm6', 'HC_type':1, 'url': '/11; /1; /12;'},
                'vs2': {'vs_ip': '10.235.160.76', 'host_name':'vkvm160076.sqa.cm6', 'HC_type':1, 'url': '/11; /12; /13;'},
                'vs3': {'vs_ip': '10.235.160.86', 'host_name':'vkvm160086.sqa.cm6', 'HC_type':1, 'url': '/1; /12; /2;'}},
    tcheck.deploy(conf)
...
def test_1tcheck_3vs_3uri_3down_16():
    ...
    conf['vs']={'vs1': {'vs_ip': '10.235.160.66', 'host_name':'vkvm160066.sqa.cm6', 'HC_type':1, 'url': '/11; /12; /13;'},
                'vs2': {'vs_ip': '10.235.160.76', 'host_name':'vkvm160076.sqa.cm6', 'HC_type':1, 'url': '/11; /12; /13;'},
                'vs3': {'vs_ip': '10.235.160.86', 'host_name':'vkvm160086.sqa.cm6', 'HC_type':1, 'url': '/11; /12; /13;'}},
    tcheck.deploy(conf)
...
def test_3tcheck_1vs_3uri_1down_17():
    ...
    conf['vs']={'vs1': {'vs_ip': '10.235.160.66', 'host_name':'vkvm160066.sqa.cm6', 'HC_type':1, 'url': '/11; /2; /3;'}}
    tcheck.deploy(conf)
...
def test_3tcheck_3vs_3uri_partdown_19():
    conf['tcheck'] = {'master': 'master','slave':['slave1', 'slave2', 'slave3']}
    conf['vs']={'vs1': {'vs_ip': '10.235.160.66', 'host_name':'vkvm160066.sqa.cm6', 'HC_type':1, 'url': '/1; /12; /13;'},
                'vs2': {'vs_ip': '10.235.160.76', 'host_name':'vkvm160076.sqa.cm6', 'HC_type':1, 'url': '/11; /1; /2;'},
                'vs3': {'vs_ip': '10.235.160.86', 'host_name':'vkvm160086.sqa.cm6', 'HC_type':1, 'url': '/11; /2; /13;'}},
    tcheck.deploy(conf)
...
def test_3tcheck_3vs_3uri_partrsdown_21():
    conf['tcheck'] = {'master': 'master','slave':['slave1', 'slave2', 'slave3']}
    conf['vs']={'vs1': {'vs_ip': '10.235.160.66', 'host_name':'vkvm160066.sqa.cm6', 'HC_type':1, 'url': '/11; /12; /13;'},
                'vs2': {'vs_ip': '10.235.160.76', 'host_name':'vkvm160076.sqa.cm6', 'HC_type':1, 'url': '/11; /1; /3;'},
                'vs3': {'vs_ip': '10.235.160.86', 'host_name':'vkvm160086.sqa.cm6', 'HC_type':1, 'url': '/11; /2; /13;'}},
    tcheck.deploy(conf)
